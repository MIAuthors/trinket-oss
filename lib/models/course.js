...
// RESET-ON-OMIT TRAP: this walks the SCHEMA's globalSettings keys, so any key
// missing from `settings` is reset to its schema default — not left alone.
// A caller that sends a partial settings object silently wipes the rest. In
// particular the Edit Course form must keep sending markdownEngine (as it must
// already send courseType/contentDefault/copyable), or saving any other course
// setting would quietly downgrade a modern-engine course back to the default.
