...
var engineFor    = require('../shared/markdown-engine.js').engineFor,
    markedModern = require('../../public/js/vendor/marked-modern.js'),
    createDOMPurify = require('../../public/js/vendor/purify.min.js'),
    JSDOM        = require('jsdom').JSDOM,
    hljs         = require('highlight.js');

var modernFactory = require('../../public/js/trinket-markdown-modern.js');

// The require above stays at module load (the vendored files MUST be resolvable
// at boot — see public/js/vendor), but BUILDING the parser is deferred: it
// constructs a JSDOM window, and a deploy whose courses are all legacy should
// not pay for that at startup. Memoized on first modern render.
