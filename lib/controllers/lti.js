...
module.exports = {
  ...
  deepLinkSelect: function(request, reply) {
    var b = request.payload || {};
    // Same fallback as the picker: the form carries ctx forward so a selection can
    // still be returned to the LMS when the launch's cookie was refused (#217).
    var dl = request.yar.get('ltiDeepLink') || ltiDeepLinkCtx.verify(b.ctx);
  ...
  deepLinkPicker: function(request, reply) {
    ...
    var dl = request.yar.get('ltiDeepLink') || ctxDl;
