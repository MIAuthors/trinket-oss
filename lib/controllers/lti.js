...
function handleLti11Launch(request, reply) {
  ...
  return new Promise(function (resolve) {
    ...
    var verdict = lti11Verify.verify({
      method: 'POST', url: launchUrl, params: body, secret: consumer.secret
    });
    if (!verdict.ok) {
...
module.exports = {
  ...
  configXml11: function(request, reply) {
    ...
    var xml = '<?xml version="1.0" encoding="UTF-8"?>\n' +
      ...
      '  <blti:title>Trinket</blti:title>\n' +
      '  <blti:description>Write and run Python and Web VPython in the browser.</blti:description>\n' +
