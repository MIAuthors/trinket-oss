...
/**
 * Check if access-code course self-enrollment is enabled
 * @returns {boolean} - True only when explicitly enabled, false otherwise
 */
...
module.exports = {
  ...
  isAccessCodeEnrollmentEnabled: isAccessCodeEnrollmentEnabled,
