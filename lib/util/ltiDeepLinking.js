...
// Course/topic placement: a plain resource link, no lineItem. Always carries trinket_course (the
// resolution + enrollment unit); a topic link additionally carries trinket_topic (the lesson id),
// so ltiTarget can land the user on that topic within the resolved course.
