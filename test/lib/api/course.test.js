...
describe('Course Creation', () => {
  describe('As a logged in user', () => {
    ...
    describe('When I edit an existing course', () => {
      ...
      // Runs on BOTH backends: preserveSlug (a post('init') hook) captures
      // _original_slug on load, and the Firestore backend now runs post('init')
      // hooks in docToInstance (it used to drop them, so this 404'd on Firestore).
      it('should redirect me to the current course if I use the original course slug', async () => {
