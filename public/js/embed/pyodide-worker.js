(function(root) {
  ...
  if (typeof self !== 'undefined' && typeof self.postMessage === 'function' &&
    ...
    var MPL_SETUP = [
      ...
      "# also invisible where it would matter -- _snap_ns drops modules and",
      "# functions by type, and all six are one or the other. (This block keeps",
